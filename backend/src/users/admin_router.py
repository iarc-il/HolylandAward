...
from presence import count_connected_users, mark_user_connected
...
@router.get("/admin/connected-users", response_model=ConnectedUsersResponse)
async def get_connected_users(
    admin_id: str = Depends(verify_admin),
):
    return ConnectedUsersResponse(connected_users=count_connected_users())
